                        ...
                        <div class="col-lg-5 text-lg-start text-center mb-2 mb-lg-0">
                            <ul class="list-inline mb-0">
                                ...
                                <li class="list-inline-item">
                                    <a href="#!"><img src="<?= theme(''); ?>images/payment/amazonpay.svg" alt="" /></a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="#!"><img src="<?= theme(''); ?>images/payment/american-express.svg" alt="" /></a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="#!"><img src="<?= theme(''); ?>images/payment/mastercard.svg" alt="" /></a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="#!"><img src="<?= theme(''); ?>images/payment/paypal.svg" alt="" /></a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="#!"><img src="<?= theme(''); ?>images/payment/visa.svg" alt="" /></a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-7 mt-4 mt-md-0">
                            <ul class="list-inline mb-0 text-lg-end text-center">
                                ...
                                <li class="list-inline-item ms-4">
                                    <a href="#!"><img src="<?= theme(''); ?>images/appbutton/appstore-btn.svg" alt="" style="width: 140px" /></a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="#!"><img src="<?= theme(''); ?>images/appbutton/googleplay-btn.svg" alt="" style="width: 140px" /></a>
                                </li>
                            </ul>
                        </div>
                    </div>
